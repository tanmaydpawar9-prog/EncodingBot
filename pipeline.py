    ...
    if gpu_id not in _OCR_ENGINES:
        ...
        try:
            ...
            _OCR_ENGINES[gpu_id] = PaddleOCR(
                ...
                # RTX 6000 96 GB VRAM — large batch sizes for maximum throughput
                det_batch_num=32, rec_batch_num=64,
                show_log=False,
            )
...
def _process_frame_stream(engine, cmd, bytes_per_frame, crop_h, crop_w, crop_x, crop_y, extract_fps, time_offset, cancel_check, is_target_res=False, progress_cb=None):
    ...
    if process.poll() is not None and process.returncode != 0:
        ...
        raise RuntimeError(f"FFmpeg crashed: {err[:200]}")
